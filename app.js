            ...
            try {
                ...
                if (servicesSnapshot.empty) {
                    const defaultServices = [
                        ...
                        { name: 'Rang o\'zgartirish', price: 100000, duration: 60 }
                    ];
                ...
                if (barbersSnapshot.empty) {
                    const defaultBarbers = [
                        { name: 'Ali', rating: 4.8, avatar: '👨‍🦰', available: true, reviewCount: 15 },
                        { name: 'Muhammad', rating: 4.9, avatar: '👨‍🦱', available: true, reviewCount: 20 },
                        { name: 'Usman', rating: 4.7, avatar: '👨‍🦲', available: false, reviewCount: 12 },
                        { name: 'Karim', rating: 4.6, avatar: '👨‍🎓', available: true, reviewCount: 10 }
                    ];
